...

{
   ...
   "proof": {
      "proof_type": "jwt",
      "jwt":
      "eyJqd2siOnsia3R5IjoiRUMiLCJjcnYiOiJQLTI1NiIsIngiOiJIUFpBRzBTMmNs
       a1E3NFBCNzZMRzkxazJyX09ia0lueHM0bDREVnVlbERVIiwieSI6Imx4bGducXBr
       NTQzc08yZl92MzJYREswVzlHeUdBckQyUGVYdjlkWEZ2a1kifSwidHlwIjoib3Bl
       bmlkNHZjaS1wcm9vZitqd3QiLCJhbGciOiJFUzI1NiJ9.eyJhdWQiOiAiaHR0cHM
       6Ly9jcmVkZW50aWFsLWlzc3Vlci5leGFtcGxlLmNvbS9jcmVkZW50aWFsIiwgIml
       hdCI6IDE3MDE5NjA0NDQsICJub25jZSI6ICJMYXJSR1NibVVQWXRSWU82QlE0eW4
       4In0.kdFT-
       j4UQYeQEKhTYrdUckbJMxSlQiagDeuMT3jP0x0cRZDf_p7R5zEbBcdflitZux_Uv
       vpgdI4OPca1GCF8gw"
   }
}
```
...
* in the JWT body,
  ...
  * `aud`: REQUIRED (string). The value of this claim MUST correspond to the URL of the Issuer's endpoint where the JWT is being transmitted.
...
```json
{
  ...
  "aud": "https://credential-issuer.example.com/credential",
  "iat": 1701960444,
...
{
  "iss": "s6BhdRkqt3",
  "aud": "https://server.example.com/credential",
  "iat": 1659145924,
  "nonce": "tZignsnFbp"
}
```
...
* in the content of the message (see [@!RFC8392], Section 4),
  ...
  * Claim Key 3 (`aud`): REQUIRED (text string). The value of this claim MUST correspond to the URL of the Issuer's endpoint where the CWT is being transmitted.
