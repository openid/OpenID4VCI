...
* `credential_type`: REQUIRED. Space delimited, case sensitive list of ASCII string values that specify the type of the Credential the Wallet shall request. A single ASCII space character (0x20) MUST be used as the delimiter.
