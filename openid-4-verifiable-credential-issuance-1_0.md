...
* `credential_response_encryption`: OPTIONAL. Object containing information whether the Credential Issuer requires encryption of the (Batch) Credential Response on top of TLS. If this object is present, the Credential Issuer expects Credential and/or Batch Credential Response to be encrypted. If this object is omitted, Credential  and/or Batch Credential Response should not be encrypted.
