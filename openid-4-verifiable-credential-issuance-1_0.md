...
* `encryption_key`: OPTIONAL (object). Contains the encryption public key of the Wallet in JWK form. The JWK MUST match the `jwk` object inside the `credential_response_encryption` parameter of a Credential Request.
