...
`proof_types` claim is an extension point that enables the use of different types of proofs for different cryptographic schemes.
...
This specification defines the following values for `proof_type` claim:
