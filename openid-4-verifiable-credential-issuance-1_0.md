...
* `display`: OPTIONAL. Object containing a list of name/value pairs, where each name identifies the language as language tag values defined in BCP47 [@!RFC5646] and where each value represents a localized display object with the following non-exhaustive list of parameters that MAY be included:
...
* `claims`: OPTIONAL. Object containing a list of name/value pairs, where each name identifies a claim about the subject offered in the Credential. The value can be another such object (nested data structures), or an array of such objects. To express the specifics about the claim, the most deeply nested value MAY be an object that includes a following non-exhaustive list of parameters defined by this specification:
    ...
    * `display`: OPTIONAL. Object containing a list of name/value pairs, where each name identifies the language as language tag values defined in BCP47 [@!RFC5646] and where each value represents a localized display object for a claim with the following non-exhaustive list of parameters that MAY be included:
      * `name`: OPTIONAL. The localized String value of a display name for the claim
