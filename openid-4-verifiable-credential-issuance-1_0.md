...
* invalid_or_missing_nonce - the Credential Request did not contain a `proof` parameter with a nonce provided by the issuer
...

{
  ...
  "error_description":
       "Credential Issuer requires Issuer-provided nonce to be included in the proof."
  "c_nonce": "8YE9hCnyV2",
  "c_nonce_expires_in": 86400  
}
```
