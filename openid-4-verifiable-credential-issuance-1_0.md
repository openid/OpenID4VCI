...
* `credential_response_encryption`: OPTIONAL. Object containing information whether the Credential Issuer requires encryption of the (Batch) Credential Response. If this request element is not present, the (Batch) Credential Response returned should not be encrypted.
