...
Requirements around if and how the client identifies and authenticates itself with the authorization server in the Token Request as described in Sections 4.1.3 and 3.2.1 of [@!RFC6749] MUST be followed.
